...
public class TemperatureSeriesAnalysisTest {
    ...
    public void testDeviation() {
        double[] temperatureSeries = {3.0, -5.0, 1.0, 5.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        double expResult = 3.741657386773;
    ...
    @Test
    public void testfindTempsSummaryStatistics() {
        double[] temperatureSeries = {3.0, -5.0, 1.0, 5.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        TempSummaryStatistics actualResult = seriesAnalysis.summaryStatistics();

        assertEquals(1.0, actualResult.getAvgTemp(), 0.00001);
        assertEquals(3.741657386773, actualResult.getDevTemp(), 0.00001);
    ...
    @Test
    public void testfindaddTemps() {
        double[] temperatureSeries = {3.0, -5.0, 1.0, 5.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        int expResult = 8;

        int actualResult = seriesAnalysis.addTemps(2.0, 3.0, -1.0, 7.0);
